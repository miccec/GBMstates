...
aConsensus <- ConsensusClusterPlus(d = ddist, maxK = 5, reps = 10000, pItem = 0.7,
                                   innerLinkage = "ward.D2", finalLinkage = "ward.D2", distance = "euclidean")
aConsensus <- aConsensus[[5]]
...
names(consClust) <- colnames(consensusdist)
